...
export default async function Hero() {
  ...
  const sheetUnavailable = matches === null
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-16 md:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-12 items-center">
          ...
          <div className="hidden lg:flex flex-col gap-4">
            ...
            {sheetUnavailable ? (
              /* Sheet unreachable */
              <div className="rounded-3xl border border-sunset/[0.2] bg-white/[0.04] p-5 text-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8 text-sunset mx-auto mb-3">
                  <rect width="18" height="18" x="3" y="4" rx="2" ry="2" />
                  <line x1="16" x2="16" y1="2" y2="6" />
                  <line x1="8" x2="8" y1="2" y2="6" />
                  <line x1="3" x2="21" y1="10" y2="10" />
                </svg>
                <p className="text-base font-bold text-sunset mb-1">Pending Schedule Soon</p>
                <p className="text-xs text-cloud/40">Match schedule is being updated. Check back shortly.</p>
              </div>
            ) : nextMatch ? (
              /* Has upcoming/live match */
              ...
              /* No games today / no upcoming */
              <div className="rounded-3xl border border-white/[0.08] bg-white/[0.05] p-6 text-center">
                <div className="flex justify-center mb-3">
                  <div className="relative w-16 h-16">
                    {/* Field graphic */}
                    <div className="absolute inset-0 rounded-full bg-gradient-to-br from-leaf/[0.15] to-aqua/[0.1] border border-leaf/[0.2]" />
                    <div className="absolute inset-0 flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8 text-leaf/60">
                ...
                <p className="text-base font-bold text-cloud mb-1">No Games Today</p>
                <p className="text-xs text-cloud/40 mb-3">The fields are resting. Next match details coming soon.</p>
                <Link href="/maps#schedule" className="text-xs text-aqua hover:text-neon font-semibold transition-colors">
